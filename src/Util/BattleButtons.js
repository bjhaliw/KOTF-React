  ...
  return (
    <>
      <Box
        ...
        alignContent="center"
      >
        <Button variant="contained" onClick={handleAttack} color="primary">
          Attack
        </Button>
        <Button variant="contained" onClick={handleMagic} color="primary">
          Magic
        </Button>
        <Button variant="contained" onClick={handleItem} color="primary">
          Use Item
        </Button>
        <Button variant="contained" onClick={handleRunAway} color="primary">
          Run Away
        </Button>
      </Box>
    </>
